...
describe(__filename, () => {
  ...
  describe('JSON serialization', () => {
    ...
    it('should properly serialize whole record', () => {
      ...
      expect(JSON.stringify(r)).to.equal('{"recordID":"0","moduleID":"0","namespaceID":"0","revision":0,"values":[{"name":"simple","value":"foo"},{"name":"multi","value":"bar"},{"name":"multi","value":"baz"}],"meta":{},"canUpdateRecord":false,"canReadRecord":false,"canDeleteRecord":false,"canManageOwnerOnRecord":false,"canSearchRevision":false,"canGrant":false}')
    })
